...
//         GroupCycle cycle = groupCycleService.createCycle(createDto);
...
//         GroupCycle cycle = groupCycleService.findById(cycleId);
...
//         GroupCycle cycle = groupCycleService.updateStatus(cycleId, statusDto.getStatus());
//         return ResponseEntity.ok(GroupCycleResponseDto.fromEntity(cycle));
//     }
...
//         List<GroupCycle> cycles = groupCycleService.findByGroupId(groupId);
