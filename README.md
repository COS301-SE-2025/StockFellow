  ...
  <ol>
    <li>
      ...
      <ul>
        ...
        <li><a href="#management-and-deployment">Management and Deployment</a></li>
        <li><a href="#testing">Testing</a></li>
      </ul>
    </li>
    <li><a href="#roadmap">Roadmap</a></li>
    <li><a href="#documentation">Documentation</a></li>
    <li><a href="#git-structure-and-strategy">Git Structure and Strategy</a></li>
...
| [Architectural Specification](https://github.com/COS301-SE-2025/StockFellow/blob/dev/docs/Architectural%20Requirements/Stockfellow_Architectural_Requirements.pdf) | Architectural Patterns, Strategies and Functional Requirements   |
| [Coding Standard](https://github.com/COS301-SE-2025/StockFellow/blob/dev/docs/Coding%20Standards/Stockfellow_Coding_Standards.pdf) | Coding best practices to follow and programming guidelines   |
| [Deployment Model](https://github.com/COS301-SE-2025/StockFellow/blob/dev/docs/Deployment%20Model/Stockfellow_Deployment_Model.pdf) | Deployment architecture and infrastructure specifications |
...
Our planned workspace organization:
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 200px; padding: 15px; border: none;">
      <img src="docs/images/Tino.jpg" alt="Tinotenda Chirozvi" style="width: 100%; border-radius: 8px;">
    </td>
  ...
  <tr>
    <td style="vertical-align: top; width: 200px; padding: 15px; border: none;">
      <img src="docs/images/Dean.jpg" alt="Dean Ramsay" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="vertical-align: top; padding: 15px; border: none;">
  ...
  <tr>
    <td style="vertical-align: top; width: 200px; padding: 15px; border: none;">
      <img src="docs/images/Diyaana.jpg" alt="Diyaana Jadwat" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="vertical-align: top; padding: 15px; border: none;">
      ...
      <div style="margin-top: 15px;">
        <a href="https://github.com/diyjadwat" style="text-decoration: none; margin-right: 10px; display: inline-block;">
          <img src="https://skillicons.dev/icons?i=github" alt="GitHub" />
        </a>
  ...
  <tr>
    <td style="vertical-align: top; width: 200px; padding: 15px; border: none;">
      <img src="docs/images/Luba.jpg" alt="Lubabalo Tshikila" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="vertical-align: top; padding: 15px; border: none;">
